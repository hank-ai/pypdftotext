...
This module provides a class for managing the PDF transform stack.
"""
from collections import ChainMap, Counter
from pypdf import _text_extraction as tex

from .pdf_fonts import Font, TextStateParams
...
class XformStack:
    ...
    def __init__(self) -> None:
        ...
        self.font_size: int | float | None = None

    def text_state_params(self, txt: str = ""):
    ...
    def reset_trm(self) -> ChainMap[int | str, float | bool]:
    ...
    def add_trm(self, operands: list[float | int]):
    ...
    def flip_vertical(self) -> bool:
        ...
        return self.effective_xform[3] < -1e-6  # copy behavior of orient() func in pypdf
